...
open Tezos_protocol_009_PsFLoren.Protocol.Apply
open Tezos_client_009_PsFLoren
open Api_error
...
type op_result = {
    ...
    balance_updates : Receipt_repr.balance_updates; (** List of balance updates *)
    ...
    big_map_diff : Lazy_storage.Lazy_storage_diff.diffs option ; (** Changes in the BigMap *)
